...
// Troca as imagens de AWS e GitHub conforme o tema
function updateTechLogos() {
  const isLight = document.body.classList.contains('light-mode');
  document.querySelectorAll('.aws-img').forEach(img => {
    img.src = isLight ? img.dataset.imgLight : img.dataset.imgDark;
  });
...
if (toggle) {
  ...
  window.addEventListener('DOMContentLoaded', updateTechLogos);
}